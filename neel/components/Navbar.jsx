...
const Navbar = (IsDarkMode, setIsDarkMode) => {
    ...
    return (
        ...
        <nav alt="" className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4
        flex item-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" :""}`}>
            ...
            top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition druntion-500 dark:bg-darkHover dark:text-white'>
